# Container-first Claw Code Bastion workflows
...
If you want to run `claw` against a second checkout while keeping the Claw Code Bastion checkout mounted read-write:
